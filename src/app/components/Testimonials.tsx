...
export default function Testimonials() {
 ...
 : "bg-primary-100 hover:bg-primary-200 dark:hover:bg-primary-800"
 }`}
 >
 {/* Avatar */}
 ...
 <div className="bg-primary-100 rounded-3xl p-8 md:p-12 relative min-h-[400px] transition-all">
 {/* Quote Mark */}
 <div className="absolute top-8 right-8 text-8xl font-serif text-gray-300 opacity-50">
 66
 </div>
